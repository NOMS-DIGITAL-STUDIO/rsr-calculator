...
const calcSanctionOccasions = (x) => Math.min(50, (x.previousSanctions || 0) + 1);
...
const calcOGRS3SanctionOccasionsFactor = (x) =>
  Math.min(50, parseInt(x.previousSanctions || 0, 10) + 1) * x.coefficients.ogrs3_sanctionoccasions;
