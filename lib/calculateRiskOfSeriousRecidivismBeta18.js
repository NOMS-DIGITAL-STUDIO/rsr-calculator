...
function calculateScore(o) {
    o.allSanctions = o.allSanctions || o.previousSanctions;
...
/*
    console.log({
      score,
      probabilityOfNonSexualViolence: [ probabilityNonSexualViolenceY1, probabilityNonSexualViolenceY2 ],
      indecentImageProbability: [ indecentImageProbabilityY1, indecentImageProbabilityY2 ],
      contactSexualProbability: [ contactSexualProbabilityY1, contactSexualProbabilityY2 ],
      riskOfSeriousRecidivism: [ totalRSRY1, totalRSRY2 ]
    });
*/
