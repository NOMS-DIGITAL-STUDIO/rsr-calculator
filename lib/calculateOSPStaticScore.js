...
const lookupScoreForAgeAtMostRecentSexOffence = n =>
...
const calculateMaleOSPStaticScore = x =>
  0 +
    ...
    lookupScoreForAgeAtMostRecentSexOffence(x.ageAtMostRecentSexOffence) +
...
module.exports = x =>
  calculateOSPStaticScore({
    ...
    ageAtMostRecentSexOffence: x.ageAtMostRecentSexOffence,
