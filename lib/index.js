...
const calculateRisk = (x) =>
  withValidInputs(x, collect([
    ...
    ['OSPScore', calculateOffenderSexualProbability],
    ...
    */
    ...
    ['riskOfSeriousRecidivismBeta18', (x) => calcRiskOfSeriousRecidivismBeta18(x).totalRSR],
    ...
    ['RSRRiskBandNodeJS', calcRSRRiskBand('riskOfSeriousRecidivismNodeJS')],
